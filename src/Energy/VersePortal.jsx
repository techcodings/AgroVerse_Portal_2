...
const allFeatures = [
    ...
    },
   {
    ...
    // ✅ Add this line
    demoUrl: "https://solar-wind-power-forecast.netlify.app/",

    tags: ['Forecasting', 'Solar', 'Wind', 'Prediction']
},

    { id: 3, title: 'EV Charging Demand Prediction', icon: Battery, category: 'EV & Grid Management', color: 'green-emerald', desc: 'Regional demand heatmaps with peak load predictions', inputs: ['EV Registration Data', 'Open Charge Map', 'OSM Road Network', 'Historical Usage'], outputs: ['Demand Heatmap', 'Peak Load Predictions', 'Scenario Simulations', 'TTS Alerts'], ml: ['LSTM', 'Graph Transformer', 'Multimodal Fusion'], datasets: ['Open Charge Map', 'OpenStreetMap', 'Open-Meteo'], integration: 'Backend + User Input',demoUrl:"https://ev-charging-prediction.netlify.app/", tags: ['EV', 'Prediction', 'Grid', 'Demand'] },
    { id: 4, title: 'Grid & Microgrid Optimization Advisor', icon: Zap, category: 'Energy Forecasting & Optimization', color: 'emerald-teal', desc: 'Load balancing and battery storage scheduling', inputs: ['Real-time Solar/Wind Generation', 'EV Demand', 'Grid Topology', 'Energy Pricing'], outputs: ['Load Balancing Charts', 'Battery Schedule', 'Grid Stress Metrics', 'Scenario Simulations'], ml: ['Reinforcement Learning', 'Multimodal Transformer'], datasets: ['OPSD', 'ENTSO-E', 'Electricity Maps'], integration: 'Backend + User Input',demoUrl: "https://grid-microgrid-optimization-advisor.netlify.app/", tags: ['Grid', 'Optimization', 'Battery', 'AI'] },
    { id: 5, title: 'Energy Market & Policy Impact Simulator', icon: TrendingUp, category: 'Energy Forecasting & Optimization', color: 'indigo-purple', desc: 'Policy scenarios and supply/demand projections', inputs: ['Historical Market Data', 'Policy Reports', 'Satellite Imagery', 'ERA5 Weather'], outputs: ['Policy Impact Maps', 'Pricing Projections', 'Scenario Dashboards', 'Text Summaries'], ml: ['RAG', 'LLM', 'Temporal Transformer'], datasets: ['IRENA', 'OpenEI', 'World Bank', 'IEA'], integration: 'Backend + User Input',demoUrl:"https://energy-markett.netlify.app/", tags: ['Market', 'Policy', 'Economics', 'Simulation'] },
    { id: 6, title: 'Climate & Renewable Anomaly Detector', icon: AlertTriangle, category: 'Solar & Renewable Monitoring', color: 'red-pink', desc: 'Abnormal generation detection with severity ranking', inputs: ['Real-time Weather', 'Satellite Imagery', 'Grid Output Data', 'Climate Event Streams'], outputs: ['Anomaly Heatmaps', 'Temporal Plots', 'Severity Rankings', 'Automated Alerts'], ml: ['Temporal GNN', 'Anomaly Detection Transformer'], datasets: ['Sentinel-2', 'ERA5', 'NASA FIRMS', 'NOAA'], integration: 'Backend',demoUrl:"https://climate-renewable-detector.netlify.app/", tags: ['Anomaly', 'Climate', 'Detection', 'Alerts'] },
